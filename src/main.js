(function preloadGlbUnlessSaveData() {
  try {
...
(function () {
      ...
      function onScroll() {
        ...
        var pastHero = false;
        if (heroEl) {
          pastHero = y > Math.max(0, heroEl.offsetHeight - 72);
        } else {
          pastHero = y > 120;
        }
        if (nav) {
      ...
      /* —— 3D showcase: model-viewer + fallback —— */
